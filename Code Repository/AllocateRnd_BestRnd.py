# Constructive Heuristic: Allocate Rnd_BestRnd
# Refer Section 4.5 in Dissertation and Section D.5.2 in Documentation.
...
def call_allocate_rnd_bestrnd():
    c = 1
    while(c!=0):
        print(c)
        initial_allocation, initial_penalty = allocate_rnd_bestrnd()
        c-=1
    return initial_allocation, initial_penalty

initial_allocation, initial_penalty = call_allocate_rnd_bestrnd()
