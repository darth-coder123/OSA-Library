# Neighbourhood Exploration Driving Metaheuristic: Simulated Annealing Rnd BestRnd
# Refer Section 4.7.2.2 in Dissertation and Section D.6.4 in Documentation.


initial_temperature = 500
best_penalty = initial_penalty  # Refers to the intial penalty of the allocation passed down from the constructive heuristic.
...
def relocate_rnd_bestrnd(allocation, current_penalty, random_entity, selected_room, temperature, best_penalty, best_feasible_allocation, best_feasible_penalty, best_feasible_allocation_iteration, num_iterations):
    ...
    if penalty < current_penalty:
        ...
        if temperature>0:
            acc_prob = math.exp((current_penalty - penalty)/temperature)
        else:
            acc_prob = 0
...
def swap_rnd_bestrnd(allocation, current_penalty, random_entity_1, selected_entity_2, temperature, best_penalty, best_feasible_allocation, best_feasible_penalty, best_feasible_allocation_iteration, num_iterations):
...
def saa_rnd_bestrnd(allocation, current_penalty):
    ...
    num_iterations = 0
    max_iterations = 20000  # User can change this value to regulate the stopping criterion.
    ...
    while(num_iterations!=max_iterations):
        ...
        if neighbourhood_structure == 'relocate_rnd_bestrnd':
            ...
            allocation, current_penalty, best_penalty, best_feasible_allocation, best_feasible_penalty, best_feasible_allocation_iteration = relocate_rnd_bestrnd(allocation,current_penalty, random_entity,min_approx_penalty[0], temperature, best_penalty, best_feasible_allocation, best_feasible_penalty, best_feasible_allocation_iteration, num_iterations)
            ...
            allocation, current_penalty, best_penalty, best_feasible_allocation, best_feasible_penalty, best_feasible_allocation_iteration = swap_rnd_bestrnd(allocation, current_penalty, random_entity_1, min_approx_penalty_swap[0], temperature, best_penalty, best_feasible_allocation, best_feasible_penalty, best_feasible_allocation_iteration, num_iterations)
...
saa_rnd_bestrnd(initial_allocation, initial_penalty)
